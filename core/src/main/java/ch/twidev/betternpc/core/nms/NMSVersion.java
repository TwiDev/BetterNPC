...
public enum NMSVersion {
    ...
    /* 1.8.4 - 1.8.9   */ v1_8_R3(() -> new ch.twidev.betternpc.nms.v1_8_R3.NMSManager()),
    /* 1.9 - 1.9.3     */ v1_9_R1(NMSManagerFactory.outdatedVersion("1.9.4")),
    /* 1.9.4           */ v1_9_R2(() -> null),
    /* 1.10 - 1.10.2   */ v1_10_R1(() -> null),
    /* 1.11 - 1.11.2   */ v1_11_R1(() -> null),
    /* 1.12 - 1.12.2   */ v1_12_R1(() -> null),
    /* 1.13            */ v1_13_R1(NMSManagerFactory.outdatedVersion("1.13.1")),
    /* 1.13.1 - 1.13.2 */ v1_13_R2(() -> null),
    /* 1.14 - 1.14.4   */ v1_14_R1(() -> null),
    /* 1.15 - 1.15.2   */ v1_15_R1(() -> null),
    ...
    /* 1.16.4 - 1.16.5 */ v1_16_R3(() -> null),
    /* 1.17            */ v1_17_R1(() -> null),
    /* 1.18 - 1.18.1   */ v1_18_R1(() -> null),
    /* 1.18.2          */ v1_18_R2(() -> null),
    /* 1.19 - 1.19.2   */ v1_19_R1(() -> null),
    /* 1.19.3          */ v1_19_R2(() -> null),
    /* 1.19.4          */ v1_19_R3(() -> null),
    /* 1.20 - ?        */ v1_20_R1(() -> null),
